...
export function Gallery() {
  ...
  return (
    <>
      ...
      {selectedImage && (
        <div
          className={`fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 ${isClosing
        ...
        >
          <div
            className={`relative w-full max-w-4xl h-[80vh] rounded-lg overflow-hidden ${isClosing
